...
\begin{frame}{HP 17bII+: Cálculo de Tasa Real}
    No hay función directa para tasa real, pero podemos calcularla con aritmética algebraica.
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \midrule
        \texttt{1.12 $\div$ 1.05 =} & 1.0667 & Factor real \\
        \texttt{$-$ 1 =} & 0.0667 & Tasa real decimal \\
        \texttt{$\times$ 100 =} & \textbf{6.67} & Tasa real \% \\
        \bottomrule
    \end{tabular}
    \end{center}
...
\begin{frame}{HP 17bII+: Valor Presente con Inflación}
    \begin{block}{Problema}
    ...
    \textbf{Opción 1: Usar tasa nominal directamente} (\texttt{FIN} $\to$ \texttt{TVM})
    \begin{center}
    \begin{tabular}{@{}lll@{}}
        \toprule
        \textbf{Teclas} & \textbf{Display} & \textbf{Descripción} \\
        ...
        \texttt{10 I\%YR} & 10.00 & Tasa nominal \\
...
\begin{frame}{HP 17bII+: Poder Adquisitivo del VP}
    ...
    \textbf{Ajuste por inflación futura:} (\texttt{FIN} $\to$ \texttt{TVM})
    \begin{center}
    \begin{tabular}{@{}lll@{}}
        \toprule
        \textbf{Teclas} & \textbf{Display} & \textbf{Descripción} \\
        ...
        \texttt{4 I\%YR} & 4.00 & Tasa de inflación \\
        \texttt{5 N} & 5.00 & Períodos \\
