...
\begin{frame}{Objetivos de Aprendizaje}
    ...
    \begin{enumerate}
        ...
        \item Usar la HP 12C para cálculos de amortización
    \end{enumerate}
\end{frame}
...
\begin{frame}{HP 12C: Funciones de Amortización}
    \begin{center}
    \begin{tabular}{@{}cl@{}}
        \toprule
        \textbf{Teclas} & \textbf{Función} \\
        \midrule
        \texttt{f AMORT} & Muestra interés de los próximos períodos \\
        \texttt{x$\leftrightarrow$y} & Alterna: muestra capital amortizado \\
        \texttt{RCL PV} & Muestra saldo insoluto actual \\
        \bottomrule
    \end{tabular}
    \end{center}
    ...
    \textbf{Procedimiento:}
    \begin{enumerate}
        \item Ingresar datos del préstamo (PV, i, n, calcular PMT)
        \item Ingresar número de períodos a amortizar
        \item Presionar \texttt{f AMORT} para ver interés
        \item Presionar \texttt{x$\leftrightarrow$y} para ver capital
        \item \texttt{RCL PV} para ver nuevo saldo
    \end{enumerate}
\end{frame}

\begin{frame}{HP 12C: Ejemplo de Amortización}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \texttt{12 n} & 12 & Meses \\
        \texttt{1.5 i} & 1.5 & Tasa mensual \\
        \texttt{0 FV} & 0 & Sin valor residual \\
        \texttt{PMT} & -4,607.08 & Pago mensual \\
        \texttt{3 f AMORT} & -2,111.14 & Interés meses 1-3 \\
        \texttt{x$\leftrightarrow$y} & -11,710.09 & Capital meses 1-3 \\
        \texttt{RCL PV} & 38,289.91 & Saldo después de 3 pagos \\
        \bottomrule
    \end{tabular}
    \end{center}
\end{frame}

\begin{frame}{HP 12C: Saldo en Cualquier Momento}
    \begin{block}{Problema}
    ...
    \begin{center}
    \begin{tabular}{@{}lll@{}}
        \texttt{5 f AMORT} & -1,486.45 & Interés meses 4-8 \\
        \texttt{RCL PV} & 16,755.27 & Saldo después de pago 8 \\
    \end{tabular}
    \end{center}
...
\begin{frame}{Conceptos Clave}
    \begin{enumerate}
        ...
        \item HP 12C: \texttt{f AMORT} para desglose
    \end{enumerate}
\end{frame}
...
\begin{frame}{Tarea para la Próxima Sesión}
    \begin{enumerate}
        ...
        \item \textbf{HP 12C:} Usa \texttt{f AMORT} para verificar el interés de los primeros 3 meses del ejercicio anterior.
