...
\begin{frame}{Objetivos de Aprendizaje}
    ...
    \begin{enumerate}
        ...
        \item Usar la HP 17bII+ en modo BEG para anualidades anticipadas
    \end{enumerate}
\end{frame}
...
\begin{frame}{HP 17bII+: Modo BEGIN para Anticipadas}
    \textbf{Ruta:} \texttt{FIN} $\to$ \texttt{TVM} $\to$ \texttt{OTHER}
    ...
    \begin{tabular}{@{}cl@{}}
        ...
        \midrule
        \texttt{OTHER} $\to$ \texttt{END} & Modo anualidad ordinaria (pagos al final) \\
        \texttt{OTHER} $\to$ \texttt{BEG} & Modo anualidad anticipada (pagos al inicio) \\
        \bottomrule
    \end{tabular}
    \end{center}
...
\begin{frame}{HP 17bII+: Ejemplo - Renta Anticipada}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \texttt{OTHER} $\to$ \texttt{BEG} & BEGIN & Modo anticipada \\
        \texttt{12000 PMT} & 12,000.00 & Pago mensual \\
        \texttt{24 N} & 24.00 & 24 meses \\
        \texttt{0.8 I\%YR} & 0.80 & 0.8\% mensual \\
...
\begin{frame}{HP 17bII+: Ejemplo - Fondo de Retiro Anticipado}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \texttt{CLEAR DATA} & 0.00 & Limpiar \\
        \texttt{OTHER} $\to$ \texttt{BEG} & BEGIN & Modo anticipada \\
        \texttt{5000 +/- PMT} & -5,000.00 & Depósito mensual \\
        \texttt{240 N} & 240.00 & 240 meses \\
        \texttt{0.6 I\%YR} & 0.60 & 0.6\% mensual \\
...
\begin{frame}{HP 17bII+: Perpetuidades (Cálculo Manual)}
    La HP 17bII+ no tiene función de perpetuidad, pero es fácil calcular:
    ...
    \begin{block}{Perpetuidad Simple: $PV = PMT/r$}
        ...
        \begin{tabular}{@{}lll@{}}
            \textbf{Teclas} & \textbf{Display} & \textbf{Descripción} \\
            \midrule
            \texttt{50000 $\div$ 0.08 =} & \textbf{625,000} & PV = PMT/r \\
        \end{tabular}
        \end{center}
    \end{block}
    ...
    \begin{block}{Perpetuidad Creciente: $PV = PMT/(r-g)$}
        ...
        \begin{tabular}{@{}lll@{}}
            \textbf{Teclas} & \textbf{Display} & \textbf{Descripción} \\
            \midrule
            \texttt{50000 $\div$ (0.08 $-$ 0.03) =} & \textbf{1,000,000} & PV = PMT/(r-g) \\
        \end{tabular}
        \end{center}
    \end{block}
\end{frame}
...
\begin{frame}{Conceptos Clave}
    \begin{enumerate}
        ...
        \item HP 17bII+: usar \texttt{OTHER} $\to$ \texttt{BEG} para anticipadas
