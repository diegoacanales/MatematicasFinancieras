...
\begin{frame}{Objetivos de Aprendizaje}
    ...
    \begin{enumerate}
        ...
        \item Calcular el valor presente de flujos futuros con HP 17bII+ y Python
    \end{enumerate}
\end{frame}
...
\begin{frame}{HP 17bII+: Recordatorio de Teclas}
    \textbf{Ruta:} \texttt{FIN} $\to$ \texttt{TVM} (verificar \texttt{P/YR = 1})
    ...
    \begin{tabular}{@{}cl@{}}
        ...
        \texttt{+/-} & Cambiar signo \\
        \texttt{CLEAR DATA} & Limpiar registros financieros \\
        \bottomrule
    \end{tabular}
    \end{center}
...
\begin{frame}{HP 17bII+: Ejemplo 1 - Valor Presente Básico}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \texttt{9 I\%YR} & 9.00 & Tasa 9\% anual \\
...
\begin{frame}{HP 17bII+: Ejemplo 2 - Comparar Opciones}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \texttt{10 I\%YR} & 10.00 & Tasa 10\% anual \\
...
\begin{frame}{HP 17bII+: Ejemplo 3 - Encontrar la Tasa Implícita}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \midrule
        \texttt{CLEAR DATA} & 0.00 & Limpiar \\
        \texttt{850 +/- PV} & -850.00 & Precio (lo que pagas) \\
        \texttt{1000 FV} & 1,000.00 & Valor al vencimiento \\
        \texttt{3 N} & 3.00 & 3 años \\
        \texttt{I\%YR} & \textbf{5.57} & Tasa anual \\
        \bottomrule
    \end{tabular}
    \end{center}
