...
\begin{frame}{Objetivos de Aprendizaje}
    ...
    \begin{enumerate}
        ...
        \item Utilizar la HP 12C y Python para cálculos financieros
    \end{enumerate}
\end{frame}
...
% ===========================================
% SECCIÓN 6: CALCULADORA HP 12C
% ===========================================
\section{Calculadora HP 12C}

\begin{frame}{HP 12C: Teclas Financieras Básicas}
    \begin{center}
        \begin{tabular}{@{}cl@{}}
            \toprule
            ...
            \texttt{CLx} & Borrar display \\
            \texttt{f} \texttt{CLX} & Borrar registros financieros \\
            \bottomrule
        \end{tabular}
    \end{center}
    ...
    \begin{alertblock}{Convención de Signos}
        \begin{itemize}
            \item Dinero que \textbf{sale} (inversión): \textbf{negativo} (usar CHS)
            \item Dinero que \textbf{entra} (retorno): \textbf{positivo}
        \end{itemize}
    \end{alertblock}
\end{frame}

\begin{frame}{HP 12C: Ejemplo 1 - Calcular Valor Futuro}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \texttt{1000 CHS PV} & -1,000.00 & Ingresa PV (negativo: sale) \\
        \texttt{8 i} & 8.00 & Tasa de interés 8\% \\
...
\begin{frame}{HP 12C: Ejemplo 2 - Calcular Tasa de Interés}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \midrule
        \texttt{f CLX} & 0.00 & Limpiar registros \\
        \texttt{5000 CHS PV} & -5,000.00 & Valor presente (sale) \\
        \texttt{8000 FV} & 8,000.00 & Valor futuro (entra) \\
        \texttt{6 n} & 6.00 & 6 períodos \\
        \texttt{i} & \textbf{8.15} & Calcula tasa de interés \\
        \bottomrule
    \end{tabular}
    \end{center}
...
\begin{frame}{HP 12C: Ejemplo 3 - Calcular Número de Períodos}
    \begin{block}{Problema}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \midrule
        \texttt{f CLX} & 0.00 & Limpiar registros \\
        \texttt{2000 CHS PV} & -2,000.00 & Valor presente \\
        \texttt{5000 FV} & 5,000.00 & Valor futuro \\
        \texttt{7 i} & 7.00 & Tasa 7\% \\
...
pip install numpy-financial
    ...
    \begin{alertblock}{Convención de Signos (igual que HP 12C)}
        \begin{itemize}
