...
\begin{frame}{Objetivos de Aprendizaje}
    ...
    \begin{enumerate}
        ...
        \item Usar la HP 17bII+ y Python para cálculos de anualidades
    \end{enumerate}
\end{frame}
...
\begin{frame}{HP 17bII+: Teclas para Anualidades}
    \textbf{Ruta:} \texttt{FIN} $\to$ \texttt{TVM}
    ...
    \begin{tabular}{@{}cl@{}}
        ...
        \texttt{I\%YR} & Tasa de interés anual nominal (\%) \\
        \texttt{PV} & Valor presente \\
        \texttt{PMT} & Pago periódico \\
        \texttt{FV} & Valor futuro \\
        \texttt{OTHER} $\to$ \texttt{END} & Modo anualidad ordinaria (default) \\
        \texttt{OTHER} $\to$ \texttt{BEG} & Modo anualidad anticipada \\
        \texttt{OTHER} $\to$ \texttt{P/YR} & Pagos por año \\
        \bottomrule
    \end{tabular}
    \end{center}
    ...
    \begin{alertblock}{Convención de Signos}
        \begin{itemize}
            \item Flujos que \textbf{salen} de ti: negativos (usar \texttt{+/-})
...
\begin{frame}{HP 17bII+: Ejemplo 1 - Calcular Pago de Préstamo}
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \texttt{OTHER} $\to$ \texttt{END} & & Modo ordinario \\
        \texttt{1 P/YR} & 1.00 & 1 pago por año \\
        \texttt{500000 PV} & 500,000.00 & Préstamo recibido (+) \\
        \texttt{48 N} & 48.00 & 48 meses \\
        \texttt{1 I\%YR} & 1.00 & 1\% mensual \\
...
\begin{frame}{HP 17bII+: Ejemplo 2 - Calcular VP de Anualidad}
    \begin{block}{Problema}
...
\begin{frame}{HP 17bII+: Ejemplo 3 - Fondo de Ahorro}
    \begin{block}{Problema}
...
\begin{frame}{Conceptos Clave}
    \begin{enumerate}
        ...
        \item La HP 17bII+ tiene funciones integradas para estos cálculos
    \end{enumerate}
\end{frame}
