...
\begin{frame}{Herramientas del Curso}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \textbf{HP 12C - Teclas Clave}
            \begin{center}
            \small
            \begin{tabular}{@{}ll@{}}
                \toprule
                \texttt{n, i, PV, PMT, FV} & TVM \\
                \texttt{g BEG/END} & Modo anualidad \\
                \texttt{f AMORT} & Amortización \\
                \texttt{g CF$_j$, g N$_j$} & Flujos \\
                \texttt{f NPV, f IRR} & VPN, TIR \\
                \bottomrule
            \end{tabular}
            \end{center}
        \end{column}
...
\begin{frame}{Aplicaciones Futuras}
    ...
    \begin{alertblock}{Consejo Final}
        Practica con problemas reales. Usa la HP 12C y Python regularmente. Los conceptos se vuelven intuitivos con la práctica.
    \end{alertblock}
\end{frame}
